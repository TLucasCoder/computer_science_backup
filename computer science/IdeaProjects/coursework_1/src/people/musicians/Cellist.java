...
public class Cellist extends Person implements Musician {
    public Cellist(String name, SoundSystem soundSystem) throws MidiUnavailableException {
        super(name);
        this.instrumentID = 43;
        this.soundSystem = soundSystem;
    }
    public Cellist(String name, SoundSystem soundSystem, int seat) throws MidiUnavailableException{
        super(name);
        this.instrumentID = 43;
        this.seat = seat;
        this.soundSystem = soundSystem;
    }
    // constructor of the cellist object
